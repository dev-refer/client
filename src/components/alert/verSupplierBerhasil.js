...
class VerSupplierBerhasil extends Component {
    state = {
        modal: false
    }
        ...
        return (
            <div>
                <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                    Alert Notifikasi Verifikasi Supplier Berhasil
                </button>
                {/* Modal */}
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content Rectangle">
                            ...
                            <div className="modal-body Text-Notification">
                                *Nama Supplier* telah sukses <br /> diverifikasi
                            </div>
                        </div>
                    </div>
                </div>
...
export default VerSupplierBerhasil;